    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "print(\"=\"*60)\n",
                "\n",
                "# Download cloudflared binary for Linux\n",
                ...
                "    print(f\"\\n📋 Moving to system PATH...\")\n",
                "    result = subprocess.run(f\"sudo cp {binary_path} {bin_path}\", shell=True, capture_output=True)\n",
                "    subprocess.run(f\"sudo chmod +x {bin_path}\", shell=True, capture_output=True)\n",
                "    print(f\"   ✅ Installed to {bin_path}\")\n",
                "    \n",
                "    # Verify\n",
                "    result = subprocess.run([\"/usr/local/bin/cloudflared\", \"--version\"], capture_output=True, text=True)\n",
                "    if result.returncode == 0:\n",
                "        print(f\"\\n✅ Verification: {result.stdout.strip()[:50]}\")\n",
                "    else:\n",
                "        print(f\"   ⚠️ Version check failed, but binary should work\")\n",
                "        \n",
                "except Exception as e:\n",
                "    print(f\"   ❌ Error: {e}\")\n",
                "    print(f\"\\n   Attempting alternative installation...\")\n",
                "    subprocess.run(\"sudo apt-get update && sudo apt-get install -y cloudflare-warp-cli\", shell=True)\n",
                "\n",
                "print(\"\\n\" + \"=\"*60)\n",
